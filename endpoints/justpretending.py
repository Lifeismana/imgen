...
class JustPretending(Endpoint):
    ...
    def generate(self, avatars, text, usernames, kwargs):
        ...
        render_text_with_emoji(
            base, canv, (678, 12), wrap(font, text[0], 320), font, "black"
        )
        render_text_with_emoji(
            base, canv, (9, 800), wrap(font, text[1], 100), font, "black"
        )
        render_text_with_emoji(
            base, canv, (399, 808), wrap(font, text[1], 100), font, "black"
        )
        render_text_with_emoji(
            base, canv, (59, 917), wrap(font, text[1], 100), font, "black"
        )
        render_text_with_emoji(
            base, canv, (425, 910), wrap(font, text[1], 100), font, "black"
        )
